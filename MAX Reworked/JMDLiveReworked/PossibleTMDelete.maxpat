...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 273.784423828125, 124.0, 22.0 ],
...
,
					"patching_rect" : [ 330.0, 199.5369873046875, 112.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 330.0, 248.5369873046875, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 416.66668701171875, 161.93701171875, 176.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 381.0, 131.93701171875, 176.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 390.66668701171875, 159.93701171875, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 364.66668701171875, 159.93701171875, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 356.0, 129.93701171875, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 330.0, 129.93701171875, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 330.0, 93.463134765625, 71.0, 22.0 ],
					"text" : "unpack i i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 62.7000732421875, 203.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1017.0, 596.2369384765625, 89.0, 22.0 ],
									"text" : "s Patch1Status"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1017.0, 447.970184326171875, 141.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1017.0, 12.0, 96.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 12.0, 96.0, 22.0 ],
									"text" : "r TotalMixOSCIn"
								}
...
,
					"patching_rect" : [ 330.0, 30.0, 99.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 34.0, 164.0, 65.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 30.0, 150.0, 20.0 ],
					"text" : "Can We Delete?"
				}
...
,
					"patching_rect" : [ 34.0, 127.0, 181.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 34.0, 103.0, 100.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 											{
												"key" : 1001,
												"value" : [ 0.533105748302321 ]
											}
, 											{
												"key" : 1002,
												"value" : [ 0.305476869512029 ]
											}
, 											{
												"key" : 1007,
												"value" : [ 0.57881805133675 ]
											}
, 											{
												"key" : 1008,
												"value" : [ 0.343286358725142 ]
											}
, 											{
												"key" : 1009,
												"value" : [ 0.110187270372917 ]
											}
, 											{
												"key" : 1011,
												"value" : [ 0.59406645306977 ]
											}
, 											{
												"key" : 1012,
												"value" : [ 0.840929508571835 ]
											}
, 											{
												"key" : 1013,
												"value" : [ 0.68566922003689 ]
											}
, 											{
												"key" : 1014,
												"value" : [ 0.571195796992478 ]
											}
, 											{
												"key" : 1015,
												"value" : [ 0.616949379030407 ]
											}
, 											{
												"key" : 1016,
												"value" : [ 0.462104044223513 ]
											}
, 											{
												"key" : 1017,
												"value" : [ 0.454245502142767 ]
											}
, 											{
												"key" : 1018,
												"value" : [ 0.502659932261904 ]
											}
, 											{
												"key" : 1019,
												"value" : [ 0.59406645306977 ]
...
,
					"patching_rect" : [ 34.0, 79.0, 144.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 34.0, 52.0, 207.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/GitHub/jmd-live/Max/JMD Live/patchers",
				"patcherrelativepath" : "../../../jmd-live/Max/JMD Live/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
